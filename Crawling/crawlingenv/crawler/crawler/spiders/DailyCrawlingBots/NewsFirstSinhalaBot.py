...
class NewsFirstSinhalaBot(scrapy.Spider):
    name = "NewsFirstSinhalaBot"
    ...
    def writeToJson(self, header, time, content, url):
        ...
        Path("../../../data/news_first/bot/sinhala").mkdir(parents=True, exist_ok=True)
        with open("../../../data/news_first/bot/sinhala/" + str(randrange(1000000)) + ".json", 'a', encoding="utf8") as ofile:
